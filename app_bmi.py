...
def bmi_app():
    """Funkcja realizująca kalkulator"""
    if request.method =='POST' and 'weight' in request.form and 'height' in request.form and\
            request.form.get('weight') != '' and request.form.get('height') != '':
